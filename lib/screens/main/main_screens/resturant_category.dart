...
class AllResurantScreen_Category extends StatefulWidget {
  const AllResurantScreen_Category({Key? key, required this.cat_id})
      : super(key: key);
  final String cat_id;
  @override
  State<AllResurantScreen_Category> createState() =>
      _AllResurantScreen_CategoryState();
}

class _AllResurantScreen_CategoryState
    extends State<AllResurantScreen_Category> {
  ...
  getData() async {
    ...
    for (var i = 0; i < querySnapshot.docs.length; i++) {
      ...
      if (m['category']['uid'] == widget.cat_id) {
        allData += [querySnapshot.docs[i].data()];
      }
    }
    print(allData);
      ...
      return Scaffold(
        ...
        body: Padding(
          ...
          child: ListView(
            ...
            children: [
              RowAll(
                mainTitle: 'قائمة المطاعم ضمن التصنيف',
                subTitle: '',
                onPressed: () {},
              ),
              SizedBox(
